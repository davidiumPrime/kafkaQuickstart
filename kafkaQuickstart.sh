...
KAFKA_HOME="{INSERT_TOP_FOLDER_OF_YOUR_KAFKA_PATH_HERE}"
ZCMD="${KAFKA_HOME}/bin/zookeeper-server-start.sh ${KAFKA_HOME}/config/zookeeper.properties"
KCMD="${KAFKA_HOME}/bin/kafka-server-start.sh ${KAFKA_HOME}/config/server.properties"
...
echo "Kafka home is set to $KAFKA_HOME"
